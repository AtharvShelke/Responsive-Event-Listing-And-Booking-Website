...
<body>
    <nav>
        <div class="container nav__container">
            ...
            <ul class="nav__items">
                ...
                <?php if (isset($_SESSION['user-id'])): ?>
                    <li class="nav__profile">
                        <div class="avatar">
                            <?php if (isset($avatar) && isset($avatar['avatar'])): ?>
            ...
            <button id="open__nav-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                    id="menu">
                    <path fill="#fff"
            ...
            <button id="close__nav-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                    id="close">
                    <path fill="#fff"
